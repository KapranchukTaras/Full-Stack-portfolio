...
export const projectsSchema: WithContext<CollectionPage> = {
  ...
  "@type": "CollectionPage",
  name: "Projects - Kapranchuk Taras",
  url: `${SITE_CONFIG.url}${SITE_SLUGS.projects}`,
  about: "Projects and case studies by Kapranchuk Taras (Next.js, React, TypeScript).",
  mainEntity: {
    "@type": "ItemList",
...
export const profilePageSchema: WithContext<ProfilePage> = {
  "@context": "https://schema.org",
  "@type": "ProfilePage",
  name: "About - Kapranchuk Taras",
  url: `${SITE_CONFIG.url}/about`,
  mainEntity: {
    "@type": "Person",
    "@id": `${SITE_CONFIG.url}/#taras`,
...
const projectBreadcrumbSchema: WithContext<BreadcrumbList> = {
  ...
  itemListElement: [
    ...
    },
    {
      ...
      name: "Kapranchuk Taras - Developer Portfolio",
      url: SITE_CONFIG.url,
      publisher: { "@id": `${SITE_CONFIG.url}#taras` },
      inLanguage: "en",
    },
    {
      "@type": "ImageObject",
